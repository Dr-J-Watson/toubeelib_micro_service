...
class GenericRdvAction extends AbstractAction{
    ...
    private \GuzzleHttp\Client $rdv_client;

    public function __construct(\GuzzleHttp\Client $rdv_client)
    {
        $this->rdv_client = $rdv_client;
    }
    ...
    public function __invoke(Request $request, Response $response, $args): Response
    {
        ...
        try {
            return $this->rdv_client->request($method, $path, $options);
